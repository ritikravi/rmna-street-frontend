...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Only auto-navigate if fully logged in (not waiting for OTP)
          ...
          {showOtp ? (
            <div>
              <button
                ...
                className="text-sm text-zinc-400 hover:text-zinc-700 mb-6 flex items-center gap-1"
              >
                ← Back
              </button>
                ...
                <div className="flex gap-3 justify-center mb-6" onPaste={handleOtpPaste}>
                  {otp.map((digit, i) => (
                    <input
                      ...
                      className={`w-12 h-14 text-center text-xl font-bold border-2 focus:outline-none transition-colors ${
                        digit ? 'border-zinc-900 bg-zinc-50' : 'border-zinc-300 focus:border-zinc-900'
                      }`}
                    />
                  ))}
                </div>
              ...
              <p className="text-center text-sm text-zinc-500">
                ...
                {resendTimer > 0 ? (
                  ...
                  <button onClick={handleResend} className="text-zinc-900 font-medium hover:underline">
                    Resend OTP
                  </button>
                )}
              </p>
